...
from ..device.manager import NSoTDevices
...
class Interface:
    ...
    # _macaddrs = _macaddr_manager.mac_addrs_generator()
    _networks = {}
    _parents = {}

    def __init__(
        self, device=None, name=None, site_name=None, resource_obj=None, **kwargs
    ):
        ...
        if not resource_obj:
            ...
            _device = NSoTDevices.get(hostname=device, site_name=site_name)
    ...
    def name_slug(self):
        ...
        return "{}:{}".format(self._device, self._name)
    ...
    def assign_virtual_mac(self):
        if self.virtual_mac is None:
            addr = next(self._macaddrs)
